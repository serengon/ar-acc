...
RETURN i.id AS investigation_id,
       coalesce(e.cuil, e.partner_id, e.cuit, e.contract_id, e.sanction_id, e.amendment_id, e.cnes_code, e.finance_id, e.embargo_id, e.school_id, e.convenio_id, e.doc_id, e.stats_id, elementId(e)) AS entity_id
