...
MATCH (e) WHERE (e.cuil = $entity_id OR e.cuit = $entity_id
  ...
  AND (e:Person OR e:Partner OR e:Company OR e:Contract OR e:Sanction OR e:Election
       ...
       OR e:Declaration OR e:DeclaredAsset OR e:DeclaredDebt)
MERGE (i)-[:INCLUDES]->(e)
RETURN i.id AS investigation_id,
       coalesce(e.cuil, e.partner_id, e.cuit, e.contract_id, e.sanction_id, e.amendment_id, e.cnes_code, e.finance_id, e.embargo_id, e.school_id, e.convenio_id, e.stats_id, elementId(e)) AS entity_id
